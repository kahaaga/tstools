...
test_that("General data model succeeds irrespective of type of stdevs", {

  expect_that(length(datamodel(data = dt, sigmas = sigmas, n.sigma = 2)),
              equals(n))
  ...
  expect_that(ncol(draw_random_data(dt, sigmas = sigmas, n.replicates = 5)),
              equals(5))
